...
def process_images():
    ...
    image_pairs = [
        # 左部分图像对
        ('./overlap_folder/lc_1_split.png', './overlap_folder/mlc_1_split.png', './caseandresult3/lc.mat', './caseandresult3/mlc.mat', './result_cross3/lc_1_compressed.png', './result_cross3/mlc_1_compressed.png')
