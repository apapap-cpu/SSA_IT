...
def compare_and_output():
    # 运行 overlap3.py
    overlap3_mips, overlap3_remaining_mem, overlap3_latency = run_and_monitor('overlap3.py')

    # 运行 overlap4.py
    overlap4_mips, overlap4_remaining_mem, overlap4_latency = run_and_monitor('overlap4.py')

    # 运行 n1.py
    n1_cpu_mips, n1_remaining_mem, n1_latency = run_and_monitor('n1.py')
    
    # 运行 n2.py
    n2_cpu_mips, n2_remaining_mem, n2_latency = run_and_monitor('n2.py')
    ...
    # 计算最大值
    max_mips = max(overlap3_mips, overlap4_mips, n1_cpu_mips, n2_cpu_mips, n3_cpu_mips) if overlap3_mips and overlap4_mips and n1_cpu_mips and n2_cpu_mips and n3_cpu_mips else None
    max_remaining_mem = max(overlap3_remaining_mem, overlap4_remaining_mem, n1_remaining_mem, n2_remaining_mem, n3_remaining_mem, key=lambda x: float(x.split()[0]))
    max_latency = max(overlap3_latency, overlap4_latency, n1_latency, n2_latency, n3_latency)
