...
def non():
    ...
    it3, D1, Xc1, Bul = getbest_uncross('./output_folder/lu_3_split.png', './caseandresult3/lu.mat', './result_cross3/lu_3_compressed.png', iter)
    end2 = datetime.datetime.now()
    time2 = (end2 - start2).seconds # Left的uncross部分用时

    start3 = datetime.datetime.now()
    it4, D2, Xc2, Bum = getbest_uncross('./output_folder/mlu_3_split.png', './caseandresult3/mlu.mat', './result_cross3/mlu_3_compressed.png', iter)
