...
def non():
    ...
    it3, D1, Xc1, Bul = getbest_uncross('./temp/lu_left_split.png', './caseandresult2/lu_left.mat', './result_cross2/lu_left_compressed.png', iter)
    end2 = datetime.datetime.now()
    time2 = (end2 - start2).seconds # Left的uncross部分用时

    start3 = datetime.datetime.now()
    it4, D2, Xc2, Bum = getbest_uncross('./temp/mlu_left_split.png', './caseandresult2/mlu_left.mat', './result_cross2/mlu_left_compressed.png', iter)
