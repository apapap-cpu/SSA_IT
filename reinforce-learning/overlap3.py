...
def process_images():
    ...
    image_pairs = [
        # 左部分图像对
        ('./temp/lc_left_split.png', './temp/mlc_left_split.png', './caseandresult2/lc_left.mat', './caseandresult2/mlc_left.mat', './result_cross2/lc_left_compressed.png', './result_cross2/mlc_left_compressed.png')
    ...
    img1 = './result_cross2/lc_left_compressed.png'
    img2 = './result_cross2/lc_right_compressed.png'
    img3 = './result_cross2/lu_left_compressed.png'
    img4 = './result_cross2/lu_right_compressed.png'
    img5 = './result_cross2/mlc_left_compressed.png'
    img6 = './result_cross2/mlc_right_compressed.png'
    img7 = './result_cross2/mlu_left_compressed.png'
    img8 = './result_cross2/mlu_right_compressed.png'
    out1 = './result_cross2/left.png'
    out2 = './result_cross2/middle.png'
    
    concatenate_4images(img1, img2, img3, img4, out1)
    concatenate_4images(img7, img8, img5, img6, out2)
