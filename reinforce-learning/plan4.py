...
def compare_and_output():
    ...
    n3_cpu_mips, n3_remaining_mem, n3_latency = run_and_monitor('non-overlap3.py')

    n4_cpu_mips, n4_remaining_mem, n4_latency = run_and_monitor('non-overlap4.py')


    # 计算最大值
    max_mips = max(overlap3_mips, overlap4_mips, n3_cpu_mips, n4_cpu_mips) if overlap3_mips and overlap4_mips and n3_cpu_mips and n4_cpu_mips else None
    max_remaining_mem = max(overlap3_remaining_mem, overlap4_remaining_mem, n3_remaining_mem, n4_remaining_mem, key=lambda x: float(x.split()[0]))
    max_latency = max(overlap3_latency, overlap4_latency, n3_latency, n4_latency)
