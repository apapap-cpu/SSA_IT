...
def compare_and_output():
    # 运行 overlap.py
    overlap_mips, overlap_remaining_mem, overlap_latency = run_and_monitor('overlap.py')

    # 运行 non-overlap.py
    non_overlap3_mips, non_overlap3_remaining_mem, non_overlap3_latency = run_and_monitor('non-overlap3.py')

    non_overlap4_mips, non_overlap4_remaining_mem, non_overlap4_latency = run_and_monitor('non-overlap4.py')


    # 计算最大值
    max_mips = max(overlap_mips, non_overlap3_mips, non_overlap4_mips) if overlap_mips and non_overlap3_mips and non_overlap4_mips else None
    max_remaining_mem = max(overlap_remaining_mem, non_overlap3_remaining_mem, non_overlap4_remaining_mem,  key=lambda x: float(x.split()[0]))
    max_latency = max(overlap_latency, non_overlap3_latency, non_overlap4_latency)
